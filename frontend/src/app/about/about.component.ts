...
export class AboutComponent implements OnInit {
  ...
  countries = [
    ['', '--Select--']
    , ['United States', 'United States'], ['Afghanistan', 'Afghanistan']
    ...
    , ['CÙte d\'Ivoire', 'Côte d\'Ivoire'], ['Croatia', 'Croatia']
    ...
    , ['Ethiopia', 'Ethiopia'], ['Falkland Islands (Malvinas)', 'Falkland Islands (Malvinas)']
    ...
    , ['Isle of Man', 'Isle of Man'], ['Israel', 'Israel']
    ...
    , ['Poland', 'Poland'], ['Portugal', 'Portugal'], ['Puerto Rico', 'Puerto Rico']
    , ['Qatar', 'Qatar'], ['Reunion', 'Reunion']
    , ['Romania', 'Romania'], ['Russian Federation', 'Russian Federation']
    , ['Rwanda', 'Rwanda'], ['Saint BarthÈlemy', 'Saint Barthélemy']
    , ['Saint Helena', 'Saint Helena'], ['Saint Kitts and Nevis', 'Saint Kitts and Nevis']
    ...
    , ['Switzerland', 'Switzerland'], ['Syrian Arab Republic', 'Syrian Arab Republic']
